...
data = pd.read_csv('../build/data_' + str(dataset) + '.csv', sep=',', index_col=False, header=None, names=['time', 'lon', 'lat'])
mlog = pd.read_csv('../build/mxlog_' + str(dataset) + '.csv', sep=',', index_col=False, header=None, names=['time', 'who', 'msg'])
pts = pd.read_csv('../build/pts.csv', sep=',',index_col=False, header=None, names=['lon', 'lat'])
