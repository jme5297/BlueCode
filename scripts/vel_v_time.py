...
plt.plot(data['time'], data['gpsVel'], color='blue', linewidth=4.0, label='GPS Velocity (m/s)')
#plt.plot(data['time'], data['vel'], color='green', linewidth=4.0, label='Actual Velocity (m/s)')
#plt.grid(b=True, which='both', linestyle='-')
#plt.xlabel('Time (sec)')
#plt.ylabel('Velocity (m/s)')

#plt.subplot(2,1,1)
plt.plot(data['time'], data['throtGain'], color='black', linewidth=4.0, label='PID Factor')
#plt.grid(b=True, which='both', linestyle='-')
#plt.xlabel('Time (sec)')
